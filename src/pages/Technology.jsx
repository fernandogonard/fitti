    ...
    <BackgroundWrapper>
      <main className="min-h-screen w-full px-4 py-12 flex flex-col items-center justify-center text-white">
        <section className="max-w-4xl w-full mb-12 text-center">
          ...
          <p className="text-lg md:text-xl font-medium mb-6">Descubre la innovación detrás de los guantes fittipald1. Cada detalle está pensado para el máximo rendimiento y protección en el arco.</p>
        </section>
        <section className="grid grid-cols-1 md:grid-cols-5 gap-10 w-full max-w-5xl mb-16">
          <div className="col-span-3 flex flex-col justify-center">
            <div className="flex items-center mb-6">
              <FaHandPaper className="text-orange-500 text-4xl mr-4" />
              <div>
            ...
            <div className="flex items-center mb-6">
              <FaHandRock className="text-orange-500 text-4xl mr-4" />
              <div>
            ...
            <div className="flex items-center">
              <FaLock className="text-orange-500 text-4xl mr-4" />
              <div>
          ...
          <div className="col-span-2 flex items-center justify-center">
            <img src="/assets/technology-gloves.webp" alt="Guantes fittipald1" className="w-full max-w-md" />
          </div>
        </section>
        <section className="w-full max-w-3xl text-center mt-8">
          <h3 className="font-display text-xl font-bold text-orange-500 mb-2">¿Por qué elegir fittipald1?</h3>
